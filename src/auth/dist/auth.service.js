...
var argon = require("argon2"); //lib to hash password
var AuthService = /** @class */ (function () {
    function AuthService(jwt, config, repository) {
        this.jwt = jwt;
        this.config = config;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.repository.signUp(data)];
                    case 3:
                        user = _a.sent();
                        return [2 /*return*/, this.signToken(user.user_id, user.email)];
                    case 4:
                        err_1 = _a.sent();
    ...
    AuthService.prototype.signin = function (dto) {
        return __awaiter(this, void 0, void 0, function () {
            var email, user, passMatches;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = dto.email;
                        return [4 /*yield*/, this.repository.findUserByEmail(email)];
                    case 1:
                        user = _a.sent();
                        if (!user) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        secret = this.config.get('JWT_SECRET') // need to get it from .env
                        ;
