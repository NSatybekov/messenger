...
import { ChatRegistryInterface } from './chat.entity';
...
export class ChatRepository {
  ...
  async getChatName(id: number) {
    // made another method to directly find name from table its faster than making it in my code
    const chat = await this.db
      .select('name')
